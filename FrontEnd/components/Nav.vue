            ...
            <div class="main-header-item">
              <div class="main-header-menus d-flex justify-content-center align-items-center">
                ...
                <div class="header-menu d-none d-lg-block">
                  <ul>
                    <li>
                      <nuxt-link :to="url_home">{{ mse_home }}</nuxt-link>
                    </li>

                    <li>
                      <nuxt-link :to="url_news">{{ mse_news }}</nuxt-link>
                    </li>

                    <li>
                      <nuxt-link :to="url_direction">{{ mse_direction }}</nuxt-link>
                    </li>

                    <li>
                      <nuxt-link :to="url_papers">{{ mse_papers }}</nuxt-link>
                    </li>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu">
                        <li>
                          <nuxt-link :to="url_teacher">{{ mse_teacher }}</nuxt-link>
                        </li>
                        <li>
                          <nuxt-link :to="url_doctor">{{ mse_doctor }}</nuxt-link>
                        </li>
                        <li>
                          <nuxt-link :to="url_master">{{ mse_master }}</nuxt-link>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu">
                        <li>
                          <nuxt-link :to="url_all_projects">{{ mse_all_projects }}</nuxt-link>
                        </li>
                        <li>
                          <nuxt-link :to="url_single_project">{{ mse_single_project }}</nuxt-link>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu">
                        <li>
                          <nuxt-link :to="url_contact_students">{{ mse_contact_students }}</nuxt-link>
                        </li>
                        <li>
                          <nuxt-link :to="url_contact_teacher">{{ mse_contact_teacher }}</nuxt-link>
                        </li>
                      </ul>
                    </li>
                  </ul>
...
export default {
  ...
  data() {
    return {
      ...
      url_contact_teacher: "/contact-teachers",
